        ...
        {requests.map((req) => (
          ...
          >
            ...
            <div className="space-y-2 text-gray-600 text-sm mb-4">
              ...
              <p>📧 <strong>Email:</strong> {req.customerId?.email}</p>
              <p>📞 <strong>Phone:</strong> {req.customerId?.phone}</p>
            </div>
            ...
            {req.status === "accepted" && (
              <div className="mt-4">
                <a
                  href={`https://wa.me/${req.customerId?.phone}?text=Hello%20I%20accepted%20your%20service%20request`}
                  target="_blank"
